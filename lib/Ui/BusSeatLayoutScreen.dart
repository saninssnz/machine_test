...
class BusLayoutScreen extends StatefulWidget {
  ...
  BusLayoutScreen(this.busName, this.busShortName, this.driver, this.license,
      this.seatLayout);
          ...
          onTap: () {
            Navigator.of(context)
                .push(MaterialPageRoute(
                    builder: (context) => DriversListScreen(isAssign)))
                .then((value) {
              if (Provider.of<DataProvider>(context, listen: false).status ==
                  true) {
