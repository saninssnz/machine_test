        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => DriversListScreen(false)));
                        },
                        child: Container(
                          height: MediaQuery.of(context).size.height / 4,
                          width: MediaQuery.of(context).size.width,
              ...
              SizedBox(height: 20),
              Text(
                Utils.myList.length.toString() + " Buses Found",
                style: TextStyle(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        Utils.myList[position].shortName
                                            .toString(),
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Provider.of<DataProvider>(context,
                                            listen: false)
                                        .setBusId(Utils.myList[position].id
                                            .toString());
                                    ...
                                    Navigator.of(context).push(
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                BusLayoutScreen(
                                                  Utils.myList[position].name
                                                      .toString(),
                                                  Utils.myList[position]
                                                      .shortName
                                                      .toString(),
                                                  Utils.myList[position].driver
                                                      .toString(),
                                                  Utils.myList[position]
                                                      .driverLicense
                                                      .toString(),
